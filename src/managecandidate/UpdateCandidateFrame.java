...
import static managecandidate.AddCandidateFrame.path;
 ...
 * @author welcome
 */
public class UpdateCandidateFrame extends javax.swing.JFrame {

    /**
     * Creates new form UpdateCandidateFrame
     */
    ...
    public UpdateCandidateFrame() {
        super("Update Candidate Information Frame");
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBounds(0, 0, 1400, 830);
...
//          System.exit(1);
        ...
        if(ViewCandidateFrame.barr1.length>9)
                
            {
             arr1=ViewCandidateFrame.barr1;
            }
            else
            {
                String str = "symbol";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String sex="";
         ...
         String constituency=jTextField9.getText();
...
//         file.renameTo(new File(apath +"\\" + symbolname + "."+exte));
             ...
             UpadateCandidateInformation aci=new UpadateCandidateInformation();
             if(aci.doUpdateCandidate(name, age, sex, nationality,qualification, worth, profession,constituency, symbolname,fis1, partyname))
                 JOptionPane.showMessageDialog(null, "Candidate Information Updated Successfully");
             else
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateCandidateFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateCandidateFrame().setVisible(true);
            }
        });
    }
