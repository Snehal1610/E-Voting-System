 ...
 * @author welcome
 */
public class ViewCandidateFrame extends javax.swing.JFrame {

    /**
     * Creates new form View_Candidate_Frame
     */
    public static String data[][];
    UpdateCandidateFrame addrow=new UpdateCandidateFrame();
       public static byte arr1[],barr1[];
    public static FileInputStream fis1=null;
    public ViewCandidateFrame() {
        super("View Candidate Information Frame");
        initComponents();
        
        String colname[]={"Candidate Name","Constituency"};
        ViewCandidateInformation vci=new ViewCandidateInformation();
        vci.getViewCandidate();
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(0, 0, 1553, 737);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int row=jTable1.getSelectedRow();
         ...
         {
             String candidate_name=(String)model.getValueAt(row, 0);
             String constituency=(String)model.getValueAt(row, 1);
           ...
           ArrayList data=new CandidateInformationFetcher().getCandidateData(candidate_name);
           String age=(String)data.get(0);
           String sex=(String)data.get(1);
           String nationality=(String)data.get(2);
           String qualification=(String)data.get(3);
           String worth=(String)data.get(4);
           String profession=(String)data.get(5);
           String symbolname=(String)data.get(7);
            barr1 = (byte[]) data.get(8);
             String partyname=(String)data.get(9);
             
             addrow.jTextField1.setText(candidate_name);
             addrow.jTextField2.setText(age);
              if(sex.equals("Male"))
            ...
            addrow.jTextField10.setText(nationality);
            addrow.jTextField3.setText(qualification);
             addrow.jTextField4.setText(worth);
              addrow.jTextField5.setText(profession);
               addrow.jTextField9.setText(constituency);
                addrow.jTextField6.setText(symbolname);
            ImageIcon icon1 = new ImageIcon(new ImageIcon(barr1).getImage().getScaledInstance(addrow.jLabel10.getWidth(), addrow.jLabel10.getHeight(), Image.SCALE_DEFAULT));
          addrow.jLabel10.setIcon(icon1);
//          if(barr1.length>9)
//                
//            {
//             arr1=barr1;
...
//                arr1 = str.getBytes();
//            }
             addrow.jTextField8.setText(partyname);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCandidateFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewCandidateFrame().setVisible(true);
            }
        });
    }
