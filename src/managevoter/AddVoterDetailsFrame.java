 ...
 * @author welcome
 */
public class AddVoterDetailsFrame extends javax.swing.JFrame {

    /**
     * Creates new form AddVoterDetailsFrame
     */
    public AddVoterDetailsFrame() {
        super("Add Voter Details Frame");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Voter Full Name");
        ...
        jPanel1.setBounds(0, 0, 1450, 750);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jRadioButton3.isSelected())
            sex="Other";
        String dob=getDate();
        String adharno=jTextField4.getText();
        ...
        String state=(String)jComboBox1.getSelectedItem();
         ...
         if(name.isEmpty())
             ...
             JOptionPane.showMessageDialog(null, "Please Enter Age");
              ...
              JOptionPane.showMessageDialog(null, "Voter Age Should Be Greater Than Or Equal To 18");
         else if(sex.isEmpty())
          ...
          {
              AddVoterInfo aci=new AddVoterInfo();
             if(aci.doAddVoter(name, fathername,age, sex, dob, adharno, emailid, mobile, address,state))
                 JOptionPane.showMessageDialog(null, "Voter Inserted Successfully");
             else
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddVoterDetailsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddVoterDetailsFrame().setVisible(true);
            }
        });
    }
