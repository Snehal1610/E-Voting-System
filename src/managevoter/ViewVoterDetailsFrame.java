...
public class ViewVoterDetailsFrame extends javax.swing.JFrame {
    ...
    public ViewVoterDetailsFrame() {
        ...
        String colname[]={"Voter Name","Nationality","Age","Sex","Date Of Birth","Adhar Number","Email ID","Mobile Number","Permanent Address","State"};
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Voter Name", "Nationality", "Age", "Sex", "Date Of Birth", "Adhar Number", "Email Id", "Mobile Number", "Perment Address", "State"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTable1.getSelectedRowCount()==1)
        {
            ...
            String nationality=model.getValueAt(row, 1).toString();
...
//            SerialNumberKeeper.sr_no=sr;
            ...
            AddRow.jTextField2.setText(nationality);
